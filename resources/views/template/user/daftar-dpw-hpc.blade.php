...
<body id="daftar-dpw">
    ...
    <section id="daftar-dpw" class="daftar-dpw">
      <div class="container" data-aos="fade-up">
        <div class="row section-dpw">
            <div class="col-4">
            <a class="card-dpw" onClick="modalActive()">
                <div class="image">
                    <img src="{{ url('assets_user/img/blog/blog-1.jpg') }}" class="image img-1"/>
                </div>
                <div class="content-profile">
                    <div class="title">HPN Surya Indah</div>
                    <div class="subtitle">Cabang Bogor</div>
                </div>
            </a>
            </div>
            <div class="col-4" onClick="modalActive()">
            <div class="card-dpw">
                <div class="image">
                    <img src="{{ url('assets_user/img/blog/blog-1.jpg') }}" class="image img-1"/>
                </div>
  ...
  <div class="modal-dpw-dpc" id="dpw-dpc">
    <div class="section-content">
        <div class="row section-dpw">
            ...
            <div class="card-dpw">
                ...
                <div class="content-profile">
                    <div class="title">Ahmad Dahlan</div>
            ...
            <div class="card-dpw">
                ...
                <div class="content-profile">
                    <div class="title">Surya Pandawa</div>
                    <div class="subtitle">Sekretaris</div>
                </div>
            </div>
            </div>
            <div class="col-4">
            <div class="card-dpw">
                ...
                <div class="content-profile">
                    <div class="title">Syifa Umum</div>
                    <div class="subtitle">Bendahara Umum</div>
                </div>
            </div>
            </div>
        </div>
  ...
  <script>
    function modalActive() {
      var element = document.getElementById("dpw-dpc");
