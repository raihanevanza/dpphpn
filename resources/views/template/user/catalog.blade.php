            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-electronic catalog-wp">
              ...
              <div class="catalog-content">
                <div class="row" style="align-items:center">
                  ...
                  <div class="col-4 link-wp">
                    <div class="gallery-catalog">
                      <a href="../../../assets/img/portfolio/app-2.jpg" title="App 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                    <div class="detail-link">
                      <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-fashion catalog-wp">
              ...
              <div class="catalog-content">
                <div class="row" style="align-items:center">
                  ...
                  <div class="col-4 link-wp">
                    <div class="gallery-catalog">
                      <a href="../../../assets/img/portfolio/app-3.jpg" title="App 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                    <div class="detail-link">
                      <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-sport catalog-wp">
              ...
              <div class="catalog-content">
                <div class="row" style="align-items:center">
                  ...
                  <div class="col-4 link-wp">
                    <div class="gallery-catalog">
                      <a href="../../../assets/img/portfolio/books-1.jpg" title="App 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                    <div class="detail-link">
                      <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-electronic catalog-wp">
              ...
              <div class="catalog-content">
                <div class="row" style="align-items:center">
                  ...
                  <div class="col-4 link-wp">
                    <div class="gallery-catalog">
                      <a href="../../../assets/img/portfolio/books-2.jpg" title="App 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                    <div class="detail-link">
                      <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-food catalog-wp">
              ...
              <div class="catalog-content">
                <div class="row" style="align-items:center">
                  ...
                  <div class="col-4 link-wp">
                    <div class="gallery-catalog">
                      <a href="../../../assets/img/portfolio/books-3.jpg" title="App 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                    <div class="detail-link">
                      <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                    </div>
