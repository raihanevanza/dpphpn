...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Agenda Organisasi</h1>
</div>

<!-- DataTales Example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form - Agenda Organisasi </h6>
    </div>
    <div class="card-body row">
        <div class="col-xl-8 col-lg-7">
            <form method="POST" class="user" accept-charset="utf-8" enctype="multipart/form-data" action="<?= ($action == 'create') ? url('master-organization-agenda') : url('master-organization-agenda/'.$data['id']) ?>">
                @if ($action == 'edit')
                @method('patch')
                @endif
                @csrf
                ...
                <a href="<?php echo url('/master-organization-agenda') ?>" class="btn btn-secondary">Kembali</a>
            </form>
        </div>
    </div>
</div>
