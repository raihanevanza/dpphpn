...
<div class="card shadow mb-4">
    ...
    <div class="card-body row">
        <div class="col-xl-8 col-lg-7">
            <form method="POST" class="user" accept-charset="utf-8" enctype="multipart/form-data" action="<?= ($action == 'create') ? url('master-vision') : url('master-vision/'.$data['id']) ?>">
                @if ($action == 'edit')
                @method('patch')
                @endif
                @csrf
                ...
                <a href="<?php echo url('/master-vision') ?>" class="btn btn-secondary">Kembali</a>
            </form>
        </div>
    </div>
</div>
